import cv2
#defining color properties for Pepsi and Cocacola
def colorProfiles(n):
    if n == 0:
        name = "Pepsi"
...
#Reading the image as Frame
frame = cv2.imread("bottleimage2.0.jpg")
hsv = cv2.cvtColor(frame, cv2.COLOR_BGR2HSV)
rects = {}

for i in range(2):
    #Displaying the name after identifying the bottle such as Pepsi or Coke
    ...
    #Displaying a rectangular line accross the boundries of the bottle
